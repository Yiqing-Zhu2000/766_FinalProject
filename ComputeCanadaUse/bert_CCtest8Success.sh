...
#SBATCH --time=0-00:30
#SBATCH --output=test7Whole-%j.out
...
cp ~/projects/rrg-skrishna/yzhu439/766Project_CCTest/Tmp.zip $SLURM_TMPDIR
...
pip install --no-index -r $SLURM_TMPDIR/Tmp/requirements_clean.txt

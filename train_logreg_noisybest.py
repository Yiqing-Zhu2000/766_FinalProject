...
def main():
    ...
    print(" Training Logistic Regression on NoisyAG-NewsBest ...")
    ...
    os.makedirs("output_model/logreg_noisybest", exist_ok=True)
    with open("output_model/logreg_noisybest/model.pkl", "wb") as f:
        pickle.dump(clf, f)
    with open("output_model/logreg_noisybest/vectorizer.pkl", "wb") as f:

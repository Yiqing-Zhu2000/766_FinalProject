...
def main():
    ...
    print(" Training Logistic Regression on NoisyAG-NewsMid ...")
    ...
    os.makedirs("output_model/logreg_noisymid", exist_ok=True)
    with open("output_model/logreg_noisymid/model.pkl", "wb") as f:
        pickle.dump(clf, f)
    with open("output_model/logreg_noisymid/vectorizer.pkl", "wb") as f:
